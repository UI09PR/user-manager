    ...
    <div class="mt-8 ml-8 flex flex-col gap-4">
      ...
      <div class="mt-5 flex-between">
        ...
        >
          ...
          <div
            class="bg-gray-900 border cursor-pointer w-10 h-10 rounded-[50%]"
          >
    ...
    <div class="flex justify-between items-start w-full flex-col gap-5 mt-10">
      <div class="flex-start ml-5">
        <div class="rounded-[50%] w-20 h-20 bg-gray-500 border">
          <img
            src="https://avatars.githubusercontent.com/u/27613489"
            alt=""
            class="rounded-[50%] w-20 bg-gray-50"
          />
        </div>
        <div class="rounded-[50%] w-20 h-20 bg-gray-500 border -ml-5">
          <img
            src="https://avatars.githubusercontent.com/u/55189552"
            alt=""
            class="rounded-[50%] w-20 bg-gray-500"
          />
        </div>
        <div class="rounded-[50%] w-20 h-20 bg-gray-500 border -ml-5">
          <img
            src="https://avatars.githubusercontent.com/u/18957479"
            alt=""
            class="rounded-[50%] w-20 bg-gray-500"
          />
        </div>
        <div class="rounded-[50%] w-20 h-20 bg-gray-500 border -ml-5">
          <img
            src="https://avatars.githubusercontent.com/u/94172783"
            alt=""
            class="rounded-[50%] w-20 bg-gray-500"
          />
        </div>
        <div class="rounded-[50%] w-20 h-20 bg-gray-500 border -ml-5">
          <img
            src="https://avatars.githubusercontent.com/u/86623445"
            alt=""
            class="rounded-[50%] w-20 bg-gray-500"
          />
        </div>
...
const AsyncGitHub = defineAsyncComponent(
  () => import("@/components/ui/GitHub.vue"),
);
